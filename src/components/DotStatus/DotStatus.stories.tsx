    ...
    <div className="flex flex-col gap-48 px-48 pb-48 pt-32">
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-wrap items-center gap-16">
          ...
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="celery" />
            <span className="text-xs text-gray-400">Celery</span>
          </div>
          <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="sky" />
            <span className="text-xs text-gray-400">Sky</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="cyan" />
          ...
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="indigo" />
            <span className="text-xs text-gray-400">Indigo</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="purple" />
            <span className="text-xs text-gray-400">Purple</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="fuchsia" />
            <span className="text-xs text-gray-400">Fuchsia</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="magenta" />
            <span className="text-xs text-gray-400">Magenta</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus appearance="inverse" />
      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="flex items-end gap-24">
          <div className="flex flex-col items-center gap-8">
            <DotStatus size="compact" appearance="green" />
            <span className="text-xs text-gray-400">Compact (8px)</span>
          </div>
          <div className="flex flex-col items-center gap-8">
      ...
      {/* Border */}
      <div className="flex flex-col gap-16">
        <span className="text-sm font-medium text-gray-500">Border</span>
        <div className="flex items-center gap-24">
          <div className="flex flex-col items-center gap-8">
            <DotStatus border={false} appearance="green" />
            <span className="text-xs text-gray-400">No Border</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <DotStatus border={true} appearance="green" />
            <span className="text-xs text-gray-400">With Border</span>
          </div>
        </div>
      </div>
    </div>
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/DotStatus"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=450-6210"
          target="_blank"
          rel="noopener noreferrer"
