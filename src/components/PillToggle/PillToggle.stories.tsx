  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col gap-32">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-16">
            <div className="flex flex-col items-center gap-8">
              <PillToggle isSelected={false}>Unselected</PillToggle>
              <span className="text-xs text-gray-400">Default</span>
            </div>
            <div className="flex flex-col items-center gap-8">
              <PillToggle isSelected={true}>Selected</PillToggle>
        ...
        <div className="flex flex-col gap-8">
          <span className="text-sm font-medium text-gray-500">Single Select (Interactive)</span>
          <InteractiveExample />
        </div>

        {/* Interactive Multi Select */}
        <div className="flex flex-col gap-8">
          <span className="text-sm font-medium text-gray-500">Multi Select (Interactive)</span>
          <MultiSelectExample />
        </div>
      </div>
    )
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/PillToggle"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=717-4264"
          target="_blank"
          rel="noopener noreferrer"
