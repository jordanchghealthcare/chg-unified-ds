  ...
  render: () => (
    <div className="flex flex-col gap-32">
      ...
      <div className="flex flex-col gap-8">
        ...
        <FileUpload hasError className="w-[400px]" />
      </div>

      {/* Disabled State */}
      <div className="flex flex-col gap-8">
        <span className="text-sm font-medium text-gray-500">Disabled</span>
        <FileUpload isDisabled className="w-[400px]" />
      </div>
    </div>
  ),
}
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/FileUpload"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=3765-8060"
          target="_blank"
          rel="noopener noreferrer"
