...
const meta: Meta<typeof Branding> = {
  ...
  argTypes: {
    ...
    brand: {
      control: 'select',
      options: ['wireframe', 'connect', 'locumsmart', 'modio', 'myweatherby', 'mycomphealth', 'design-system'],
...
export const Overview: Story = {
  render: () => (
    <div className="flex flex-col gap-80 px-48">
      {/* Brands */}
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-wrap items-center gap-48">
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <span className="text-xs text-gray-400">LocumSmart</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="modio" />
            <span className="text-xs text-gray-400">Modio</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="myweatherby" />
            <span className="text-xs text-gray-400">MyWeatherby</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="mycomphealth" />
            <span className="text-xs text-gray-400">MyCompHealth</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="design-system" />
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex items-end gap-48">
          <div className="flex flex-col items-center gap-8">
            <Branding brand="wireframe" size="sm" />
            <span className="text-xs text-gray-400">Small</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="wireframe" size="md" />
            <span className="text-xs text-gray-400">Medium</span>
          </div>
          <div className="flex flex-col items-center gap-8">
            <Branding brand="wireframe" size="lg" />
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/Branding"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=525-6567"
          target="_blank"
          rel="noopener noreferrer"
