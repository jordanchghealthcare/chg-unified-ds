...
export const Overview: Story = {
  render: () => {
    const ControlledToggle = ({ defaultSelected = false, ...props }: { defaultSelected?: boolean; size?: 'default' | 'compact'; isDisabled?: boolean }) => {
      const [isSelected, setIsSelected] = useState(defaultSelected)
      return <Toggle isSelected={isSelected} onChange={setIsSelected} {...props} />
    }
    ...
    return (
      <div className="flex flex-col gap-32">
        ...
        <div className="flex flex-col gap-8">
          <span className="text-sm font-medium text-gray-500">States</span>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex items-center gap-24">
            <div className="flex flex-col items-center gap-8">
              <Toggle size="default" isSelected />
        ...
        {/* Interactive Example */}
        <div className="flex flex-col gap-8">
          <span className="text-sm font-medium text-gray-500">Interactive</span>
          <div className="flex items-center gap-24">
            <div className="flex flex-col items-center gap-8">
              <ControlledToggle />
            ...
            <div className="flex flex-col items-center gap-8">
              <ControlledToggle size="compact" defaultSelected />
              <span className="text-xs text-gray-400">Compact</span>
            </div>
          </div>
        </div>
        ...
        {/* All Sizes × States */}
        <div className="flex flex-col gap-8">
          <span className="text-sm font-medium text-gray-500">All Combinations</span>
          <div className="flex flex-col gap-16">
            {(['default', 'compact'] as const).map((size) => (
              <div key={size} className="flex items-center gap-16">
                <span className="w-64 text-xs text-gray-400 capitalize">{size}</span>
                <Toggle size={size} isSelected={false} />
                <Toggle size={size} isSelected={true} />
                <Toggle size={size} isIndeterminate />
              </div>
            ))}
          </div>
        </div>
  ...
  render: (args) => {
    const ControlledToggle = () => {
      ...
      return (
        <Toggle
          {...args}
          isSelected={args.isIndeterminate ? undefined : isSelected}
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/Toggle"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=34-3334"
          target="_blank"
          rel="noopener noreferrer"
